    ...
    namespace hardwarecommunication
    {
        ...
        protected:
            ...
            static void SetInterruptDescriptionTableEntry(
                ...
                void (*handler)(),
                myos::common::uint8_t DescriptionPrivilegeLevel,
        ...
        public:
            ...
            HandleInterrupt(myos::common::uint8_t interruptNumber, myos::common::uint32_t esp);

            myos::common::uint32_t
            DoHandleInterrupt(myos::common::uint8_t interruptNumber, myos::common::uint32_t esp);
